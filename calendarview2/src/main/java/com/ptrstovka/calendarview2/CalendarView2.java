...
import com.ptrstovka.calendarview2.utils.Pref;
...
public class CalendarView2 extends ViewGroup {
    ...
    private static TitleFormatter DEFAULT_TITLE_FORMATTER = new DateFormatTitleFormatter();
    ...
    public CalendarView2(Context context, AttributeSet attrs) {
        ...
        Locale.setDefault(Pref.getValue(context, "APP_LANGUAGE", 0) == 0 || Pref.getValue(context, "APP_LANGUAGE", 1) == 1 ? Locale.ENGLISH : Pref.getValue(context, "APP_LANGUAGE", 2) == 2 ? Locale.JAPANESE : Pref.getValue(context, "APP_LANGUAGE", 3) == 3 ? Locale.KOREAN : Locale.ENGLISH);
       ...
       TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.CalendarView2, 0, 0);
        try {
            int calendarModeIndex = a.getInteger(R.styleable.CalendarView2_mcv_calendarMode, 0);
            firstDayOfWeek = a.getInteger(R.styleable.CalendarView2_mcv_firstDayOfWeek, -1);

            titleChanger.setOrientation(a.getInteger(R.styleable.CalendarView2_mcv_titleAnimationOrientation, VERTICAL));
            ...
            newState().setFirstDayOfWeek(firstDayOfWeek).setCalendarDisplayMode(CalendarMode.values()[calendarModeIndex]).commit();
            ...
            setArrowColor(a.getColor(R.styleable.CalendarView2_mcv_arrowColor, Color.BLACK));
            Drawable leftMask = a.getDrawable(R.styleable.CalendarView2_mcv_leftArrowMask);
            if (leftMask == null) {
                leftMask = getResources().getDrawable(R.drawable.mcv_action_previous);
            }
            setLeftArrowMask(leftMask);
            Drawable rightMask = a.getDrawable(R.styleable.CalendarView2_mcv_rightArrowMask);
            if (rightMask == null) {
                rightMask = getResources().getDrawable(R.drawable.mcv_action_next);
            }
            setRightArrowMask(rightMask);

            setSelectionColor(a.getColor(R.styleable.CalendarView2_mcv_selectionColor, getThemeAccentColor(context)));
            ...
            setHeaderTextAppearance(a.getResourceId(R.styleable.CalendarView2_mcv_headerTextAppearance, R.style.TextAppearance_MaterialCalendarWidget_Header));
            setWeekDayTextAppearance(a.getResourceId(R.styleable.CalendarView2_mcv_weekDayTextAppearance, R.style.TextAppearance_MaterialCalendarWidget_WeekDay));
            setDateTextAppearance(a.getResourceId(R.styleable.CalendarView2_mcv_dateTextAppearance, R.style.TextAppearance_MaterialCalendarWidget_Date));
            //noinspection ResourceType
            setShowOtherDates(a.getInteger(R.styleable.CalendarView2_mcv_showOtherDates, SHOW_DEFAULTS));

            setAllowClickDaysOutsideCurrentMonth(a.getBoolean(R.styleable.CalendarView2_mcv_allowClickDaysOutsideCurrentMonth, true));

            setDayCirclePadding(a.getDimensionPixelOffset(R.styleable.CalendarView2_mcv_circlePadding, dayCirclePadding));
        ...
        Log.e("TestMonth","9000   " + Locale.getDefault());
        if (isInEditMode()) {
            removeView(pager);
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        newState().setFirstDayOfWeek(ss.firstDayOfWeek).setCalendarDisplayMode(ss.calendarMode).setMinimumDate(ss.minDate).setMaximumDate(ss.maxDate).isCacheCalendarPositionEnabled(ss.cacheCurrentPosition).commit();
