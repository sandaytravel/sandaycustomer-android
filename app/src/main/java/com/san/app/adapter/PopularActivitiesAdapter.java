...
import com.san.app.databinding.RowPopularActivitiesParentBinding;
...
public class PopularActivitiesAdapter extends RecyclerView.Adapter<PopularActivitiesAdapter.MyViewHolder> {

    //private List<Movie> restauarntList;
    private Context mContext;
    private RowPopularActivitiesParentBinding mBinding;
    ...
    public PopularActivitiesAdapter(Context mContext, List<ViewCityDetailModel.PopularActivity> restaurantListModelArrayList) {
        this.mContext = mContext;
        payloadList = restaurantListModelArrayList;
    }

    public PopularActivitiesAdapter(Context mContext) {
        this.mContext = mContext;
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        mBinding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()), R.layout.row_popular_activities_parent, parent, false);
