...
import com.san.app.databinding.RowPopularActivitiesCateFilterBinding;
...
public class ActivityListAdapter extends RecyclerView.Adapter<ActivityListAdapter.MyViewHolder> {
    ...
    private RowPopularActivitiesCateFilterBinding mBinding;
    private List<ActivityListModel.Payload> payloadList;
    ...
    public ActivityListAdapter(Context mContext, List<ActivityListModel.Payload> restaurantListModelArrayList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        mBinding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()), R.layout.row_popular_activities_cate_filter, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ActivityListModel.Payload payloadModel = payloadList.get(position);
        ...
        if(!TextUtils.isEmpty(payloadModel.getDisplayPrice()))mBinding.tvActualPrice.setPaintFlags(mBinding.tvActualPrice.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);
        ...
        if (mBinding.lnReview.getVisibility() == View.VISIBLE)
            mBinding.tvTotalBooked.setPadding(15, 0, 0, 0);
        ...
        Glide.with(mContext)
                .load(payloadModel.getFullsizeImage())
