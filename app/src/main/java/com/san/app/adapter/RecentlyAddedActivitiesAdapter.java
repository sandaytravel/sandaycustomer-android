...
public class RecentlyAddedActivitiesAdapter extends RecyclerView.Adapter<RecentlyAddedActivitiesAdapter.MyViewHolder> {

    private Context mContext;
    private RowPopularActivityHomeBinding mBinding;
    private List<ViewCityDetailModel.Recentlyadded> payloadList;
    ...
    public RecentlyAddedActivitiesAdapter(Context mContext, List<ViewCityDetailModel.Recentlyadded> restaurantListModelArrayList) {
        this.mContext = mContext;
        payloadList = restaurantListModelArrayList;
    }

    public RecentlyAddedActivitiesAdapter(Context mContext) {
        this.mContext = mContext;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ViewCityDetailModel.Recentlyadded payloadModel = payloadList.get(position);
