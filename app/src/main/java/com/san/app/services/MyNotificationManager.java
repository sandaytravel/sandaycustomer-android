...
public class MyNotificationManager {
    ...
    public void displayNotification(String title, String body, String order_id) {
        ...
        Intent resultIntent = new Intent(mCtx, DashboardActivity.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP).putExtra("is_from", "notification").putExtra("order_id", "" + order_id);
